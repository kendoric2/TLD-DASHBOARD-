    ...
    return {
        ...
        "active_by_carrier": [
            {"carrier": "Aetna", "sold": 87, "active": 79,
             "states": [{"state": "TX", "active": 22, "sold": 24}, {"state": "FL", "active": 18, "sold": 20}, {"state": "GA", "active": 11, "sold": 12}]},
            {"carrier": "UnitedHealthcare", "sold": 75, "active": 68,
             "states": [{"state": "TX", "active": 20, "sold": 22}, {"state": "OH", "active": 15, "sold": 16}, {"state": "NC", "active": 8, "sold": 9}]},
            {"carrier": "Humana", "sold": 59, "active": 52,
             "states": [{"state": "GA", "active": 16, "sold": 18}, {"state": "TX", "active": 12, "sold": 13}]},
            {"carrier": "Cigna", "sold": 44, "active": 39,
             "states": [{"state": "TN", "active": 14, "sold": 15}, {"state": "NC", "active": 9, "sold": 10}]},
            {"carrier": "WellCare", "sold": 28, "active": 24, "states": [{"state": "FL", "active": 13, "sold": 15}]},
            {"carrier": "Other", "sold": 19, "active": 15, "states": [{"state": "AZ", "active": 6, "sold": 7}]},
        ],
        "by_state": [
        ...
        "enrollments": {
            ...
            "by_enroller": [
                {"fronter_id": "40067", "name": "Charles, Rony", "count": 7,
                 "detail": [{"agent": "Okcuoglu, Kaan", "carrier": "Aetna", "count": 4}, {"agent": "Desir, G", "carrier": "UHC", "count": 3}]},
                {"fronter_id": "14847", "name": "Desir, G", "count": 5,
                 "detail": [{"agent": "Brown, Ernest", "carrier": "Humana", "count": 3}, {"agent": "Okcuoglu, Kaan", "carrier": "Cigna", "count": 2}]},
                {"fronter_id": "38784", "name": "Escoffery, Lashaunah", "count": 5,
                 "detail": [{"agent": "Barros, Matheus", "carrier": "UHC", "count": 5}]},
                {"fronter_id": "42283", "name": "Chevelon, Ziea", "count": 4,
                 "detail": [{"agent": "Mckenzie, Michael", "carrier": "Aetna", "count": 2}, {"agent": "Teheran, Eli", "carrier": "WellCare", "count": 2}]},
                {"fronter_id": "52081", "name": "Teheran, Eli", "count": 3,
                 "detail": [{"agent": "Desir, G", "carrier": "UHC", "count": 3}]},
                {"fronter_id": "51497", "name": "Lozano, Mario", "count": 2,
                 "detail": [{"agent": "Brown, Ernest", "carrier": "Humana", "count": 2}]},
                {"fronter_id": "37669", "name": "Desormot, Jean", "count": 1,
                 "detail": [{"agent": "Okcuoglu, Kaan", "carrier": "Aetna", "count": 1}]},
                {"fronter_id": "43148", "name": "Gomez, Carlos", "count": 2,
                 "detail": [{"agent": "Chevelon, Ziea", "carrier": "Cigna", "count": 2}]},
            ],
        },
    }
...
def get_sample_board(range_label="Today"):
    ...
    return {
        "demo": True,
        "range_label": range_label,
        "carriers": ["Aetna", "Cigna", "Humana", "UnitedHealthcare", "WellCare"],
        "board": [
